...
#SBATCH --error /srv/beegfs/scratch/users/b/burmistr/ctapipe/prod5/NSB_268MHz/gamma/job_error/crgen_%j.error
#SBATCH --output /srv/beegfs/scratch/users/b/burmistr/ctapipe/prod5/NSB_268MHz/gamma/job_output/output_%j.output
#SBATCH --ntasks 1
