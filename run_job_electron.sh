...
#SBATCH --error /srv/beegfs/scratch/users/b/burmistr/ctapipe/prod5/NSB_268MHz/electron/job_error/crgen_%j.error
#SBATCH --output /srv/beegfs/scratch/users/b/burmistr/ctapipe/prod5/NSB_268MHz/electron/job_output/output_%j.output
#SBATCH --ntasks 1
